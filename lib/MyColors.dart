// ignore_for_file: file_names, constant_identifier_names, unnecessary_const
import 'dart:ui';

class SolidColors {
  static const Color PrimaryColor = Color.fromARGB(150, 68, 4, 87);
...
class GradientColors {
  ...
  static const List<Color> HashtagsColor = [
    const Color.fromARGB(255, 0, 0, 0),
    Color.fromARGB(255, 63, 63, 63)
  ];

  static const List<Color> BlogListGradient = [
    const Color.fromARGB(255, 0, 0, 0),
